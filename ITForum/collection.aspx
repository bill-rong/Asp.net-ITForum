<%@ Page Title="ITForum-我的收藏" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="collection.aspx.cs" Inherits="collection" %>
          ...
          <div class="tab-content" style="margin-bottom:10px;">
            <div role="tabpanel" class="tab-pane active" id="home" >
                <table class="table table-hover">
                    ...
                    <tbody>
                    <%
                        if(drsForumColl != null)
                        {
                            int i = 0;
                            foreach(System.Data.DataRow dr in drsForumColl)
                            {
                                i++;
                    %>
            ...
            <div role="tabpanel" class="tab-pane" id="profile" >
                <table class="table table-hover">
                    ...
                    <tbody>
                    <%
                        if(drsQuestionColl != null)
                        {
                            int i = 0;
                            foreach(System.Data.DataRow dr in drsQuestionColl)
                            {
                                i++;
                    %>
                            <tr>
            ...
            <div role="tabpanel" class="tab-pane" id="messages" >
                <table class="table table-hover">
                    ...
                    <%
                        ...
                        {
                            int i = 0;
                            foreach(System.Data.DataRow dr in drsCodeColl)
                            {
                                i++;
                    %>
                            <tr>
