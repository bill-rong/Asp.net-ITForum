...
public partial class BackGround_QuesChecked : System.Web.UI.Page
{
    ...
    public void Bind(int CurrentPage)
    {
        ...
        this.quesList.DataSource = ps;
        this.quesList.DataKeyField = "id";
        this.quesList.DataBind();
    ...
    protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            string id = e.CommandArgument.ToString();   //获取要更改行的id号,执行修改命令
            operation.updataQuestion(id);
            Response.Redirect(Request.Url.ToString());
        }
    }
