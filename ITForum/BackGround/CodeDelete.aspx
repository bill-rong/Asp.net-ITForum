<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CodeDelete.aspx.cs" Inherits="BackGround_CodeDelete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
            <asp:DataList ID="codeList" runat="server" OnDeleteCommand="DataList1_DeleteCommand">
                <ItemTemplate>
                    <%-- 这里没有改查询的字段名 --%>
                    <table class="f-outside">       
                        ...
                        <tr>
                            <td id="pro">
                                <span class="f-text" ><%#DataBinder.Eval(Container.DataItem,"code_text") %></span>
                            </td>
                        </tr>
                        <tr>
                            <td id="time">
                                <span class="f-time"><%#DataBinder.Eval(Container.DataItem,"code_time") %></span>
                            </td>
                        </tr>
                    </table>
