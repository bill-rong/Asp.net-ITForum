<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuesDelete.aspx.cs" Inherits="BackGround_QuesDelete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
            <asp:DataList ID="quesList" runat="server" OnDeleteCommand="DataList1_DeleteCommand">
                <ItemTemplate>
